...
//                 <input type='text' name='gameName' value={review.gameName} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Description</label>
//                 <textarea name='description' value={review.description} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Rating</label>
//                 <input type='number' name='rating' value={review.rating} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Genres</label>
//                 <input type='text' name='genres' value={review.genres} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Platform</label>
//                 <input type='text' name='platform' value={review.platform} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Year</label>
//                 <input type='text' name='year' value={review.year} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>Image URL</label>
//                 <input type='text' name='image' value={review.image} onChange={handleChange} className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>User Email</label>
//                 <input type='email' name='userEmail' value={review.userEmail} readOnly className='w-full p-2 border rounded bg-gray-800' />
//             </div>
//             <div className='mb-4'>
//                 <label className='block text-sm font-bold mb-2'>User Name</label>
//                 <input type='text' name='userName' value={review.userName} readOnly className='w-full p-2 border rounded bg-gray-800' />
//             </div>
